class Keyword { 
    ...
    Keyword(String bankName, String area, String phoneNumber) { // Parameterized constructor 
    ...
    public static void main(String[] args){ 
        ...
        Keyword bank = new Keyword("IBank", "Jaydev Nagar", "8876543210"); //call default constructor 
